...
add wave -noupdate -format Logic /fifo_reg_array_sc_tb/uut/AE_AF_flag
add wave -noupdate -format Literal -radix unsigned /fifo_reg_array_sc_tb/uut/full_int
add wave -noupdate -format Literal -radix unsigned /fifo_reg_array_sc_tb/uut/empty_int
add wave -noupdate -format Literal -radix unsigned /fifo_reg_array_sc_tb/uut/raw_almost_empty
add wave -noupdate -format Literal -radix unsigned /fifo_reg_array_sc_tb/uut/raw_almost_full
