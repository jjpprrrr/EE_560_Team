...
add wave -noupdate -format Logic /fifo_tb/prod/wclk
...
add wave -noupdate -format Logic /fifo_tb/fifo/wclk
add wave -noupdate -format Logic /fifo_tb/fifo/rclk
...
add wave -noupdate -format Literal -radix hexadecimal /fifo_tb/fifo/rdptr_ss
add wave -noupdate -format Literal -radix hexadecimal /fifo_tb/fifo/wrptr_ss
add wave -noupdate -format Literal -radix hexadecimal /fifo_tb/fifo/rdptr_gray
add wave -noupdate -format Literal -radix hexadecimal /fifo_tb/fifo/wrptr_gray
add wave -noupdate -format Literal -radix hexadecimal /fifo_tb/fifo/rdptr_gray_s
add wave -noupdate -format Literal -radix hexadecimal /fifo_tb/fifo/wrptr_gray_s
add wave -noupdate -format Literal -radix hexadecimal /fifo_tb/fifo/rdptr_gray_ss
add wave -noupdate -format Literal -radix hexadecimal /fifo_tb/fifo/wrptr_gray_ss
add wave -noupdate -format Literal -radix hexadecimal /fifo_tb/fifo/depth_rd
add wave -noupdate -format Literal -radix hexadecimal /fifo_tb/fifo/depth_wr
add wave -noupdate -format Logic /fifo_tb/fifo/wenq
add wave -noupdate -format Logic /fifo_tb/fifo/renq
add wave -noupdate -format Logic /fifo_tb/fifo/full_int
add wave -noupdate -format Logic /fifo_tb/fifo/empty_int
...
add wave -noupdate -format Logic /fifo_tb/cons/rclk
...
add wave -noupdate -format Literal /fifo_tb/cons/rclk_clock_count
